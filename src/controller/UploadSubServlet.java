...
public class UploadSubServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (fileItemsIterator.hasNext()) {
				...
				// Lay duong dan file tai day, getRealPath se dan den metadata
				...
				out.write("<a href=\"UploadDownloadFileServlet?fileName=" + fileItem.getName() + "\">Download "
						+ fileItem.getName() + "</a>");
				RequestDispatcher rd = request.getRequestDispatcher("FormGetLink.jsp");
				rd.forward(request, response);
			}
